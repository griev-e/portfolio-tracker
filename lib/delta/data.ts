/**
 * delta — types and the sample ledger.
 *
 * delta has no backend. Your ledger lives in the browser's localStorage (see
 * lib/delta/store.tsx), exactly like alpha's portfolio. This file defines the
 ...
 * budget pacing, cash flow) is computed from the ledger in lib/delta/compute.ts.
 */
