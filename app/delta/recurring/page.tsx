...
import { recurringPerMonth } from "@/lib/delta/compute";
...
export default function RecurringPage() {
  const { ready, ledger, view, markRecurringPaid, removeRecurring } = useDelta();

  if (!ready) return null;
  if (!ledger || !view || !ledgerHasData(ledger)) return <DeltaEmpty page="Recurring charges" />;
