...
/** Shown on delta pages when the ledger is empty (after Clear). */
export function DeltaEmpty({ page }: { page: string }) {
  const { loadSample } = useDelta();
  return (
    <motion.div
    ...
    >
      ...
      <div className="mt-6 flex items-center justify-center gap-3">
        ...
        <Link href="/delta/import" className="btn-secondary">
          Import
        </Link>
      </div>
    </motion.div>
